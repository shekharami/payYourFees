...
exports.test = async (req, res, next) => {
  try {
    ...
    const school = [
      ...
      '60ae12dfe0a6fb00159612de',
      '60ae1344e0a6fb00159612df',
      '60ae13bbe0a6fb00159612e0',
      '60ae1634e0a6fb00159612e1',
      '60ae17c5e0a6fb00159612e2',
      '60ae1847e0a6fb00159612e3',
      '60ae1909e0a6fb00159612e6',
      '60ae1a92e0a6fb00159612e7',
      '60ae1ad6e0a6fb00159612e9',
      '60ae1b84e0a6fb00159612ea',
      '60ae1c38e0a6fb00159612ec',
      '60ae1cdce0a6fb00159612ed'
    ]; //13
...
exports.addStudent = async (req, res, next) => {
  try {
    const students = await User.updateOne(
      { _id: req.body.user },
    ...
    for (o of req.body) {
      ...
      feesDetails[o.name] = {
        ...
        details: await Fees.find({
          ...
          .sort('payBy')
          .limit(2)
          .select('-active -__v -addedAt -classes -programme -course -institute')
          .lean()
      };
    }
